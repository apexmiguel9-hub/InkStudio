...
#endif
#ifdef ENABLE_DITHER
e d ja(c v0,d E2,d v3){return ENABLE_DITHER?Gc(v0,E2,v3):.0;}e v K2(v k,d e7,c v0,d E2,d v3){return(ENABLE_DITHER&&e7!=.0)?(Gc(v0,E2,v3)+k):k;}e v K2(v k,d e7,d Ic){return(ENABLE_DITHER&&e7!=.0)?(Ic+k):k;}
#else
...
#if defined(da)&&!defined(TARGET_SPIRV)
